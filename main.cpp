...
void withdrawCash() {
	...
	do {
		...
		cout << "1 - 20 rupees" << endl;
		cout << "2 - 40 rupees" << endl;
		cout << "3 - 60 rupees" << endl;
		cout << "4 - 100 rupees" << endl;
		cout << "5 - 200 rupees" << endl;
		...
		if (valueToWithdraw != 0) {
			if (valueToWithdraw > balance) {
				cout << "You just have rupees" << balance << ". You can't withdraw rupees" << valueToWithdraw << endl;
			} else {
